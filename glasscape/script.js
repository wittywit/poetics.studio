...
const update = () => {
  ...
  if (!config.animate) {
    ...
    ;(_chromaEntry = chromaEntry) === null || _chromaEntry === void 0
      ? void 0
      : _chromaEntry.scrollTrigger.disable(true, false)
    ;(_chromaExit = chromaExit) === null || _chromaExit === void 0
      ? void 0
      : _chromaExit.scrollTrigger.disable(true, false)
    ;(_dimmerScrub = dimmerScrub) === null || _dimmerScrub === void 0 ? void 0 : _dimmerScrub.disable(true, false)
    ;(_scrollerScrub = scrollerScrub) === null || _scrollerScrub === void 0
      ? void 0
      : _scrollerScrub.disable(true, false)
...
// Import additional script for form handling
import "./script-additions.js"
