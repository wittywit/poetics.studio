  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
      ...
      <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
        <Link href="/experiments" className="inline-flex items-center gap-2 mb-8 hover:text-[#fb4e4e]">
      ...
      <AnimatedSection>
        <div className="case-study-section">
          ...
          <motion.div className="case-study-full-image" variants={fadeIn}>
            <Image
      ...
      <AnimatedSection>
        <div className="case-study-section">
          ...
          <div className="case-study-image-grid">
            <motion.div className="case-study-image" variants={fadeIn}>
              <Image
      ...
      <AnimatedSection>
        <div className="case-study-section">
          ...
          <motion.div className="case-study-video" variants={fadeIn}>
            ...
            <div className="nft-grid">
              <motion.div className="nft-item" variants={fadeIn}>
                ...
                <div className="nft-content">
                  <div className="nft-title">Genesis Pass #001</div>
              ...
              <motion.div className="nft-item" variants={fadeIn}>
                ...
                <div className="nft-content">
                  <div className="nft-title">Genesis Pass #002</div>
                  <div className="nft-price">0.5 ETH</div>
                  <div className="nft-meta">
                    <span>VIP Access</span>
                    <span>Limited Edition</span>
              ...
              <motion.div className="nft-item" variants={fadeIn}>
                ...
                <div className="nft-content">
                  <div className="nft-title">Genesis Pass #003</div>
                  <div className="nft-price">0.5 ETH</div>
                  <div className="nft-meta">
                    <span>VIP Access</span>
                    <span>Limited Edition</span>
        ...
        <div className="border-t pt-12 mt-12">
          <div className="flex justify-between items-center">
            <motion.div variants={fadeIn}>
              <Link
                href="/experiments/ethical-ai-interface"
            ...
            <motion.div variants={fadeIn}>
              <Link
                href="/experiments/sustainable-tech-packaging"
                className="group flex items-center gap-2 hover:text-[#fb4e4e]"
              >
